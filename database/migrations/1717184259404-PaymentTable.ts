...
export class PaymentTable1717184259404 implements MigrationInterface {
    name = 'PaymentTable1717184259404'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."payment_status_enum" AS ENUM('new', 'proceed', 'done', 'paid')`);
